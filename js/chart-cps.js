...
function renderAllCharts(workbook) {
  ...
  function renderDemandScenario(unit, startRow) {
    const monthlyCanvas = document.getElementById(
      `workforceChart${unit}DemandScenario`
    );
    const quarterCanvas = document.getElementById(
      `workforceChart${unit}DemandPlanQtr`
    );
    ...
    new Chart(monthlyCanvas, {
      ...
      options: {
        title: {
          display: true,
          fontSize: 14,
          text: `${unit} Demand Scenario per Month`,
          padding: 20,
          fontColor: '#616161'
        },
        legend: {
    ...
    new Chart(quarterCanvas, {
      ...
      options: {
        title: {
          display: true,
          fontSize: 14,
          text: `% ${unit} Plan Scenario per Quarter`,
          padding: 20,
          fontColor: '#616161'
        },
        legend: {
  ...
  [
    ...
    ['BD', 31],
    ['PO', 41]
  ].forEach(([unit, startRow]) => {
    renderDemandScenario(unit, startRow);
  });
